...
using hls::sim::Byte;
extern "C" void atax(Byte<4>*, Byte<4>*, Byte<4>*, volatile void *);
extern "C" void apatb_atax_hw(volatile void * __xlx_apatb_param_A_0, volatile void * __xlx_apatb_param_A_1, volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_y_out) {
...
auto* sy_out = createStream(__xlx_apatb_param_y_out, 4);
  // DUT call
  atax(__xlx_A_0__tmp_vec.data(), __xlx_A_1__tmp_vec.data(), __xlx_x__tmp_vec.data(), __xlx_apatb_param_y_out);
