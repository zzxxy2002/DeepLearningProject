; ModuleID = '/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/atax_opt_36b6a5399fb21f370bdb63809fb4e2ba/hls_prj/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_atax_ir([64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "partition" %A, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %x, float* noalias nonnull "fpga.decayed.dim.hint"="64" %y_out) local_unnamed_addr #1 {
entry:
  ...
  call void @copy_in([64 x [64 x float]]* nonnull %0, [64 x [32 x float]]* %A_copy_0, [64 x [32 x float]]* %A_copy_1, [64 x float]* nonnull %1, [64 x float]* nonnull align 512 %x_copy, [64 x float]* nonnull %2, [64 x float]* nonnull align 512 %y_out_copy)
  ...
  call void @apatb_atax_hw([64 x [32 x float]]* %A_copy_0, [64 x [32 x float]]* %A_copy_1, [64 x float]* %x_copy, [64 x float]* %y_out_copy)
  call void @copy_back([64 x [64 x float]]* %0, [64 x [32 x float]]* %A_copy_0, [64 x [32 x float]]* %A_copy_1, [64 x float]* %1, [64 x float]* %x_copy, [64 x float]* %2, [64 x float]* %y_out_copy)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_in([64 x [64 x float]]* noalias readonly "orig.arg.no"="0", [64 x [32 x float]]* noalias "orig.arg.no"="1" "unpacked"="1.0" %_0, [64 x [32 x float]]* noalias "orig.arg.no"="1" "unpacked"="1.1" %_1, [64 x float]* noalias readonly "orig.arg.no"="2", [64 x float]* noalias align 512 "orig.arg.no"="3", [64 x float]* noalias readonly "orig.arg.no"="4", [64 x float]* noalias align 512 "orig.arg.no"="5") #5 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_out([64 x [64 x float]]* noalias "orig.arg.no"="0", [64 x [32 x float]]* noalias readonly "orig.arg.no"="1" "unpacked"="1.0" %_0, [64 x [32 x float]]* noalias readonly "orig.arg.no"="1" "unpacked"="1.1" %_1, [64 x float]* noalias "orig.arg.no"="2", [64 x float]* noalias readonly align 512 "orig.arg.no"="3", [64 x float]* noalias "orig.arg.no"="4", [64 x float]* noalias readonly align 512 "orig.arg.no"="5") #6 {
entry:
...
declare void @apatb_atax_hw([64 x [32 x float]]*, [64 x [32 x float]]*, [64 x float]*, [64 x float]*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_back([64 x [64 x float]]* noalias "orig.arg.no"="0", [64 x [32 x float]]* noalias readonly "orig.arg.no"="1" "unpacked"="1.0" %_0, [64 x [32 x float]]* noalias readonly "orig.arg.no"="1" "unpacked"="1.1" %_1, [64 x float]* noalias "orig.arg.no"="2", [64 x float]* noalias readonly align 512 "orig.arg.no"="3", [64 x float]* noalias "orig.arg.no"="4", [64 x float]* noalias readonly align 512 "orig.arg.no"="5") #6 {
entry:
  call fastcc void @onebyonecpy_hls.p0a64f32([64 x float]* %3, [64 x float]* align 512 %4)
  ret void
}

define void @atax_hw_stub_wrapper([64 x [32 x float]]*, [64 x [32 x float]]*, [64 x float]*, [64 x float]*) #7 {
entry:
  %malloccall = tail call i8* @malloc(i64 16384)
  %4 = bitcast i8* %malloccall to [64 x [64 x float]]*
  call void @copy_out([64 x [64 x float]]* %4, [64 x [32 x float]]* %0, [64 x [32 x float]]* %1, [64 x float]* null, [64 x float]* %2, [64 x float]* null, [64 x float]* %3)
  %5 = bitcast [64 x [64 x float]]* %4 to [64 x float]*
  %6 = bitcast [64 x float]* %2 to float*
  %7 = bitcast [64 x float]* %3 to float*
  call void @atax_hw_stub([64 x float]* %5, float* %6, float* %7)
  call void @copy_in([64 x [64 x float]]* %4, [64 x [32 x float]]* %0, [64 x [32 x float]]* %1, [64 x float]* null, [64 x float]* %2, [64 x float]* null, [64 x float]* %3)
  ret void
}
...
!15 = !DIFile(filename: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/atax_opt_36b6a5399fb21f370bdb63809fb4e2ba/opt.tcl", directory: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/atax_opt_36b6a5399fb21f370bdb63809fb4e2ba")
!16 = distinct !DISubprogram(name: "atax", scope: !17, file: !17, line: 3, type: !18, isLocal: false, isDefinition: true, scopeLine: 4, flags: DIFlagPrototyped, isOptimized: false, unit: !26, variables: !4)
!17 = !DIFile(filename: "src/atax.c", directory: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/atax_opt_36b6a5399fb21f370bdb63809fb4e2ba")
