...
auto* sE_out_1 = createStream(__xlx_apatb_param_E_out_1, 4);
  // DUT call
  k3mm(__xlx_A_0__tmp_vec.data(), __xlx_A_1__tmp_vec.data(), __xlx_B_0__tmp_vec.data(), __xlx_B_1__tmp_vec.data(), __xlx_C_0__tmp_vec.data(), __xlx_C_1__tmp_vec.data(), __xlx_D_0__tmp_vec.data(), __xlx_D_1__tmp_vec.data(), __xlx_apatb_param_E_out_0, __xlx_apatb_param_E_out_1);
