...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler k2mm_buff_B_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler k2mm_tmp2_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_E_out_0 \
    op interface \
    ports { E_out_0_din { O 32 vector } E_out_0_full_n { I 1 bit } E_out_0_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_E_out_1 \
    op interface \
    ports { E_out_1_din { O 32 vector } E_out_1_full_n { I 1 bit } E_out_1_write { O 1 bit } } \
} "
}
