; ModuleID = '/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/k2mm_opt_61d7a7fc444759d19450caf4ce7b4443/hls_prj/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_k2mm_ir(float %alpha, float %beta, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "partition" %A, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "partition" %B, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "partition" %C, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "partition" %D, [64 x float]* noalias nonnull "fpga.decayed.dim.hint"="64" "partition" %E_out) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_k2mm_hw(float %alpha, float %beta, [64 x [32 x float]]* %A_copy_0, [64 x [32 x float]]* %A_copy_1, [64 x [32 x float]]* %B_copy_0, [64 x [32 x float]]* %B_copy_1, [64 x [32 x float]]* %C_copy_0, [64 x [32 x float]]* %C_copy_1, [64 x [32 x float]]* %D_copy_0, [64 x [32 x float]]* %D_copy_1, [64 x [32 x float]]* %E_out_copy_0, [64 x [32 x float]]* %E_out_copy_1)
...
declare void @apatb_k2mm_hw(float, float, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*)
...
define void @k2mm_hw_stub_wrapper(float, float, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*, [64 x [32 x float]]*) #7 {
entry:
  %malloccall = tail call i8* @malloc(i64 16384)
  %12 = bitcast i8* %malloccall to [64 x [64 x float]]*
  %malloccall1 = tail call i8* @malloc(i64 16384)
  %13 = bitcast i8* %malloccall1 to [64 x [64 x float]]*
  %malloccall2 = tail call i8* @malloc(i64 16384)
  %14 = bitcast i8* %malloccall2 to [64 x [64 x float]]*
  %malloccall3 = tail call i8* @malloc(i64 16384)
  %15 = bitcast i8* %malloccall3 to [64 x [64 x float]]*
  %malloccall4 = tail call i8* @malloc(i64 16384)
  %16 = bitcast i8* %malloccall4 to [64 x [64 x float]]*
  call void @copy_out([64 x [64 x float]]* %12, [64 x [32 x float]]* %2, [64 x [32 x float]]* %3, [64 x [64 x float]]* %13, [64 x [32 x float]]* %4, [64 x [32 x float]]* %5, [64 x [64 x float]]* %14, [64 x [32 x float]]* %6, [64 x [32 x float]]* %7, [64 x [64 x float]]* %15, [64 x [32 x float]]* %8, [64 x [32 x float]]* %9, [64 x [64 x float]]* %16, [64 x [32 x float]]* %10, [64 x [32 x float]]* %11)
  ...
  %20 = bitcast [64 x [64 x float]]* %15 to [64 x float]*
  %21 = bitcast [64 x [64 x float]]* %16 to [64 x float]*
  call void @k2mm_hw_stub(float %0, float %1, [64 x float]* %17, [64 x float]* %18, [64 x float]* %19, [64 x float]* %20, [64 x float]* %21)
  call void @copy_in([64 x [64 x float]]* %12, [64 x [32 x float]]* %2, [64 x [32 x float]]* %3, [64 x [64 x float]]* %13, [64 x [32 x float]]* %4, [64 x [32 x float]]* %5, [64 x [64 x float]]* %14, [64 x [32 x float]]* %6, [64 x [32 x float]]* %7, [64 x [64 x float]]* %15, [64 x [32 x float]]* %8, [64 x [32 x float]]* %9, [64 x [64 x float]]* %16, [64 x [32 x float]]* %10, [64 x [32 x float]]* %11)
  ret void
}
...
!22 = !{!23, !24}
!23 = !{!"4.0", [64 x [32 x float]]* null}
!24 = !{!"4.1", [64 x [32 x float]]* null}
!25 = !{!26, !8, !28}
!26 = !{!27}
!27 = !{!"5", [64 x [64 x float]]* null}
!28 = !{!29, !30}
!29 = !{!"5.0", [64 x [32 x float]]* null}
!30 = !{!"5.1", [64 x [32 x float]]* null}
!31 = !{!32, !8, !34}
!32 = !{!33}
!33 = !{!"6", [64 x [64 x float]]* null}
!34 = !{!35, !36}
!35 = !{!"6.0", [64 x [32 x float]]* null}
!36 = !{!"6.1", [64 x [32 x float]]* null}
!37 = !DILocation(line: 9, column: 9, scope: !38)
!38 = !DILexicalBlockFile(scope: !40, file: !39, discriminator: 0)
!39 = !DIFile(filename: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/k2mm_opt_61d7a7fc444759d19450caf4ce7b4443/opt.tcl", directory: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/k2mm_opt_61d7a7fc444759d19450caf4ce7b4443")
!40 = distinct !DISubprogram(name: "k2mm", scope: !41, file: !41, line: 4, type: !42, isLocal: false, isDefinition: true, scopeLine: 5, flags: DIFlagPrototyped, isOptimized: false, unit: !49, variables: !4)
!41 = !DIFile(filename: "src/k2mm.c", directory: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/k2mm_opt_61d7a7fc444759d19450caf4ce7b4443")
!42 = !DISubroutineType(types: !43)
!43 = !{null, !44, !44, !45, !45, !45, !45, !45}
!44 = !DIBasicType(name: "float", size: 32, encoding: DW_ATE_float)
!45 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !46, size: 64)
!46 = !DICompositeType(tag: DW_TAG_array_type, baseType: !44, size: 2048, elements: !47)
!47 = !{!48}
...
!50 = !DIFile(filename: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/k2mm_opt_61d7a7fc444759d19450caf4ce7b4443/hls_prj/solution/.autopilot/db/k2mm.pp.0.c", directory: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/k2mm_opt_61d7a7fc444759d19450caf4ce7b4443")
