...
using hls::sim::Byte;
extern "C" void k2mm(float, float, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, volatile void *, volatile void *);
extern "C" void apatb_k2mm_hw(float __xlx_apatb_param_alpha, float __xlx_apatb_param_beta, volatile void * __xlx_apatb_param_A_0, volatile void * __xlx_apatb_param_A_1, volatile void * __xlx_apatb_param_B_0, volatile void * __xlx_apatb_param_B_1, volatile void * __xlx_apatb_param_C_0, volatile void * __xlx_apatb_param_C_1, volatile void * __xlx_apatb_param_D_0, volatile void * __xlx_apatb_param_D_1, volatile void * __xlx_apatb_param_E_out_0, volatile void * __xlx_apatb_param_E_out_1) {
...
std::vector<Byte<4>> __xlx_D_0__tmp_vec;
for (size_t i = 0; i < 2048; ++i){
__xlx_D_0__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D_0)[i]);
}
  int __xlx_size_param_D_0 = 2048;
  int __xlx_offset_param_D_0 = 0;
  int __xlx_offset_byte_param_D_0 = 0*4;
  // Collect __xlx_D_1__tmp_vec
std::vector<Byte<4>> __xlx_D_1__tmp_vec;
for (size_t i = 0; i < 2048; ++i){
__xlx_D_1__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D_1)[i]);
}
  int __xlx_size_param_D_1 = 2048;
  int __xlx_offset_param_D_1 = 0;
  int __xlx_offset_byte_param_D_1 = 0*4;
auto* sE_out_0 = createStream(__xlx_apatb_param_E_out_0, 4);
auto* sE_out_1 = createStream(__xlx_apatb_param_E_out_1, 4);
  // DUT call
  k2mm(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_A_0__tmp_vec.data(), __xlx_A_1__tmp_vec.data(), __xlx_B_0__tmp_vec.data(), __xlx_B_1__tmp_vec.data(), __xlx_C_0__tmp_vec.data(), __xlx_C_1__tmp_vec.data(), __xlx_D_0__tmp_vec.data(), __xlx_D_1__tmp_vec.data(), __xlx_apatb_param_E_out_0, __xlx_apatb_param_E_out_1);
...
for (size_t i = 0; i < __xlx_size_param_D_0; ++i) {
((Byte<4>*)__xlx_apatb_param_D_0)[i] = __xlx_D_0__tmp_vec[__xlx_offset_param_D_0+i];
}
// print __xlx_apatb_param_D_1
for (size_t i = 0; i < __xlx_size_param_D_1; ++i) {
((Byte<4>*)__xlx_apatb_param_D_1)[i] = __xlx_D_1__tmp_vec[__xlx_offset_param_D_1+i];
}
}
