...
set C_modelArgList {
	{ buff_D float 32 regular {array 2048 { 1 3 } 1 1 }  }
	{ buff_D_1 float 32 regular {array 2048 { 1 3 } 1 1 }  }
	{ buff_E_out float 32 regular {array 2048 { 0 3 } 0 1 }  }
	{ buff_E_out_1 float 32 regular {array 2048 { 0 3 } 0 1 }  }
	{ tmp2 float 32 regular {array 2048 { 1 3 } 1 1 }  }
	{ tmp2_1 float 32 regular {array 2048 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ grp_fu_1998_p_opcode sc_out sc_lv 2 signal -1 } 
	{ grp_fu_1998_p_dout0 sc_in sc_lv 32 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_1998_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "grp_fu_1998_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_1998_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_1998_p_dout0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	buff_D { ap_memory {  { buff_D_address0 mem_address 1 11 }  { buff_D_ce0 mem_ce 1 1 }  { buff_D_q0 mem_dout 0 32 } } }
	buff_D_1 { ap_memory {  { buff_D_1_address0 mem_address 1 11 }  { buff_D_1_ce0 mem_ce 1 1 }  { buff_D_1_q0 mem_dout 0 32 } } }
	buff_E_out { ap_memory {  { buff_E_out_address0 mem_address 1 11 }  { buff_E_out_ce0 mem_ce 1 1 }  { buff_E_out_we0 mem_we 1 1 }  { buff_E_out_d0 mem_din 1 32 } } }
	buff_E_out_1 { ap_memory {  { buff_E_out_1_address0 mem_address 1 11 }  { buff_E_out_1_ce0 mem_ce 1 1 }  { buff_E_out_1_we0 mem_we 1 1 }  { buff_E_out_1_d0 mem_din 1 32 } } }
	tmp2 { ap_memory {  { tmp2_address0 mem_address 1 11 }  { tmp2_ce0 mem_ce 1 1 }  { tmp2_q0 mem_dout 0 32 } } }
	tmp2_1 { ap_memory {  { tmp2_1_address0 mem_address 1 11 }  { tmp2_1_ce0 mem_ce 1 1 }  { tmp2_1_q0 mem_dout 0 32 } } }
