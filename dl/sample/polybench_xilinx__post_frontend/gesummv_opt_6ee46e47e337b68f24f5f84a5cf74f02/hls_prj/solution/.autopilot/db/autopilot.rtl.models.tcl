set SynModuleInfo {
  ...
  {SRCNAME gesummv_Pipeline_lp1_lp2 MODELNAME gesummv_Pipeline_lp1_lp2 RTLNAME gesummv_gesummv_Pipeline_lp1_lp2}
  {SRCNAME gesummv_Pipeline_lp3_lp4 MODELNAME gesummv_Pipeline_lp3_lp4 RTLNAME gesummv_gesummv_Pipeline_lp3_lp4}
  ...
  {SRCNAME gesummv MODELNAME gesummv RTLNAME gesummv IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME gesummv_buff_A_RAM_AUTO_1R1W RTLNAME gesummv_buff_A_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
