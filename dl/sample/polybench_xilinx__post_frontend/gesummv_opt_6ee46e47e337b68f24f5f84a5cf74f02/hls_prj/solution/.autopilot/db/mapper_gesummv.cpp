...
using hls::sim::Byte;
extern "C" void gesummv(float, float, Byte<4>*, Byte<4>*, Byte<4>*, volatile void *);
...
auto* sy_out = createStream(__xlx_apatb_param_y_out, 4);
  // DUT call
  gesummv(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_x__tmp_vec.data(), __xlx_apatb_param_y_out);
