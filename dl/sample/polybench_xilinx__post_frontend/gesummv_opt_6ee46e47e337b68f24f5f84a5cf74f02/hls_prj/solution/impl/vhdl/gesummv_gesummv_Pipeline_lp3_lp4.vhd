...
entity gesummv_gesummv_Pipeline_lp3_lp4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gesummv_gesummv_Pipeline_lp3_lp4 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln31_reg_457 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln31_fu_264_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln31_reg_457_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp2_addr_reg_470 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp2_addr_reg_470_pp0_iter1_reg : STD_LOGIC_VECTOR (5 downto 0);
    signal arrayidx67_promoted_reg_515 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage1 : signal is "none";
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal buff_B_load_reg_520 : STD_LOGIC_VECTOR (31 downto 0);
    signal buff_x_load_reg_525 : STD_LOGIC_VECTOR (31 downto 0);
    signal buff_B_1_load_reg_530 : STD_LOGIC_VECTOR (31 downto 0);
    signal buff_x_1_load_reg_535 : STD_LOGIC_VECTOR (31 downto 0);
    signal buff_B_load_1_reg_540 : STD_LOGIC_VECTOR (31 downto 0);
    signal buff_x_load_1_reg_545 : STD_LOGIC_VECTOR (31 downto 0);
    signal buff_B_1_load_1_reg_550 : STD_LOGIC_VECTOR (31 downto 0);
    signal buff_x_1_load_1_reg_555 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_reg_565 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_phi_mux_first_iter_1_phi_fu_200_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal zext_ln31_fu_322_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln33_1_fu_351_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln6_fu_337_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln33_2_fu_377_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln33_fu_363_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal j_fu_62 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal add_ln32_fu_401_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_sig_allocacmp_j_load : STD_LOGIC_VECTOR (6 downto 0);
    signal i_2_fu_66 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal select_ln31_fu_310_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_sig_allocacmp_i_2_load : STD_LOGIC_VECTOR (6 downto 0);
    signal indvar_flatten8_fu_70 : STD_LOGIC_VECTOR (10 downto 0) := "00000000000";
    signal add_ln31_1_fu_270_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_sig_allocacmp_indvar_flatten8_load : STD_LOGIC_VECTOR (10 downto 0);
    signal add6815_fu_74 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    ...
    signal add_ln31_fu_282_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal lshr_ln6_3_fu_327_p4 : STD_LOGIC_VECTOR (4 downto 0);
    signal trunc_ln31_fu_318_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_7_fu_343_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal or_ln33_fu_357_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_8_fu_369_p3 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    add6815_fu_74_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage7_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage7))) then
                if ((ap_const_boolean_1 = ap_condition_624)) then 
                    add6815_fu_74 <= arrayidx67_promoted_reg_515;
                elsif (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln31_reg_457_pp0_iter1_reg = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln31_fu_264_p2 = ap_const_lv1_0))) then 
                    i_2_fu_66 <= select_ln31_fu_310_p3;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_2_fu_66 <= ap_const_lv7_0;
                end if;
            end if; 
        end if;
    end process;

    indvar_flatten8_fu_70_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln31_fu_264_p2 = ap_const_lv1_0))) then 
                    ...
                    indvar_flatten8_fu_70 <= ap_const_lv11_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln31_reg_457 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage15_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage15))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                tmp2_addr_reg_470 <= zext_ln31_fu_322_p1(6 - 1 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage15_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage15))) then
                tmp_1_reg_565 <= add_ln32_fu_401_p2(6 downto 6);
            end if;
        end if;
    end process;
    ...
    add_ln31_1_fu_270_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten8_load) + unsigned(ap_const_lv11_1));
    add_ln31_fu_282_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_2_load) + unsigned(ap_const_lv7_1));
    add_ln32_fu_401_p2 <= std_logic_vector(unsigned(select_ln6_reg_465) + unsigned(ap_const_lv7_4));
    ...
    ap_condition_624_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln31_reg_457, or_ln6_reg_461)
    begin
                ap_condition_624 <= ((icmp_ln31_reg_457 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (or_ln6_reg_461 = ap_const_lv1_1));
    end process;


    ap_condition_628_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln31_reg_457, ap_block_pp0_stage0)
    begin
                ap_condition_628 <= ((icmp_ln31_reg_457 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_condition_exit_pp0_iter0_stage8_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage8, ap_block_pp0_stage8_subdone, icmp_ln31_reg_457)
    begin
        if (((icmp_ln31_reg_457 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage8_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage8))) then 
    ...
    ap_phi_mux_first_iter_1_phi_fu_200_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_loop_init, ap_condition_628)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) then
            if ((ap_loop_init = ap_const_logic_1)) then 
                ap_phi_mux_first_iter_1_phi_fu_200_p4 <= ap_const_lv1_1;
            elsif ((ap_const_boolean_1 = ap_condition_628)) then 
                ap_phi_mux_first_iter_1_phi_fu_200_p4 <= ap_const_lv1_0;
            else 
                ap_phi_mux_first_iter_1_phi_fu_200_p4 <= ap_const_lv1_1;
            end if;
        else 
    ...
    ap_sig_allocacmp_i_2_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_2_fu_66)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_i_2_load <= ap_const_lv7_0;
        else 
    ...
    ap_sig_allocacmp_indvar_flatten8_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, indvar_flatten8_fu_70)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    buff_B_1_address0 <= zext_ln33_2_fu_377_p1(11 - 1 downto 0);
    buff_B_1_address1 <= zext_ln33_1_fu_351_p1(11 - 1 downto 0);
    ...
    buff_B_address0 <= zext_ln33_2_fu_377_p1(11 - 1 downto 0);
    buff_B_address1 <= zext_ln33_1_fu_351_p1(11 - 1 downto 0);
    ...
    buff_x_1_address0 <= zext_ln33_fu_363_p1(5 - 1 downto 0);
    ...
    buff_x_address0 <= zext_ln33_fu_363_p1(5 - 1 downto 0);
    ...
    grp_fu_208_p0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage8, ap_CS_fsm_pp0_stage4, reg_240, ap_block_pp0_stage0, add6815_fu_74, ap_block_pp0_stage8, ap_CS_fsm_pp0_stage12, ap_block_pp0_stage12, ap_block_pp0_stage4)
    begin
    ...
    icmp_ln31_fu_264_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten8_load = ap_const_lv11_400) else "0";
    lshr_ln6_3_fu_327_p4 <= select_ln6_fu_302_p3(5 downto 1);
    or_ln33_fu_357_p2 <= (lshr_ln6_3_fu_327_p4 or ap_const_lv5_1);
    or_ln6_fu_296_p2 <= (tmp_fu_288_p3 or ap_phi_mux_first_iter_1_phi_fu_200_p4);
    select_ln31_fu_310_p3 <= 
        add_ln31_fu_282_p2 when (tmp_fu_288_p3(0) = '1') else 
        ap_sig_allocacmp_i_2_load;
    select_ln6_fu_302_p3 <= 
        ap_const_lv7_0 when (tmp_fu_288_p3(0) = '1') else 
        ap_sig_allocacmp_j_load;

    tmp2_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage8, tmp2_addr_reg_470_pp0_iter1_reg, ap_block_pp0_stage0, zext_ln31_fu_322_p1, ap_block_pp0_stage8)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage8) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage8))) then 
            ...
            tmp2_address0 <= zext_ln31_fu_322_p1(6 - 1 downto 0);
        else 
    ...
    tmp2_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage8, ap_block_pp0_stage8_11001, ap_block_pp0_stage0_11001)
    begin
    ...
    tmp2_we0_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage8, ap_block_pp0_stage8_11001, tmp_1_reg_565)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage8_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (tmp_1_reg_565 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage8))) then 
    ...
    tmp_7_fu_343_p3 <= (trunc_ln31_fu_318_p1 & lshr_ln6_3_fu_327_p4);
    tmp_8_fu_369_p3 <= (trunc_ln31_fu_318_p1 & or_ln33_fu_357_p2);
    tmp_fu_288_p3 <= ap_sig_allocacmp_j_load(6 downto 6);
    trunc_ln31_fu_318_p1 <= select_ln31_fu_310_p3(6 - 1 downto 0);
    zext_ln31_fu_322_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln31_fu_310_p3),64));
    zext_ln33_1_fu_351_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_7_fu_343_p3),64));
    zext_ln33_2_fu_377_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_fu_369_p3),64));
    zext_ln33_fu_363_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(or_ln33_fu_357_p2),64));
    zext_ln6_fu_337_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln6_3_fu_327_p4),64));
end behav;
