set SynModuleInfo {
  ...
  {SRCNAME atax_Pipeline_lp1_lp2 MODELNAME atax_Pipeline_lp1_lp2 RTLNAME atax_atax_Pipeline_lp1_lp2}
  ...
  {SRCNAME atax_Pipeline_lpwr_1 MODELNAME atax_Pipeline_lpwr_1 RTLNAME atax_atax_Pipeline_lpwr_1
    SUBMODULES {
      {MODELNAME atax_sparsemux_9_2_32_1_1 RTLNAME atax_sparsemux_9_2_32_1_1 BINDTYPE op TYPE sparsemux IMPL auto}
    }
  }
  {SRCNAME atax MODELNAME atax RTLNAME atax IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME atax_buff_A_RAM_AUTO_1R1W RTLNAME atax_buff_A_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME atax_tmp1_RAM_AUTO_1R1W RTLNAME atax_tmp1_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
}
