...
set C_modelArgList {
	{ buff_y_out float 32 regular {array 16 { 1 3 } 1 1 }  }
	{ buff_y_out_1 float 32 regular {array 16 { 1 3 } 1 1 }  }
	{ buff_y_out_2 float 32 regular {array 16 { 1 3 } 1 1 }  }
	{ buff_y_out_3 float 32 regular {array 16 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "buff_y_out", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "buff_y_out_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "buff_y_out_3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ buff_y_out_address0 sc_out sc_lv 4 signal 0 } 
	{ buff_y_out_ce0 sc_out sc_logic 1 signal 0 } 
	{ buff_y_out_q0 sc_in sc_lv 32 signal 0 } 
	{ buff_y_out_1_address0 sc_out sc_lv 4 signal 1 } 
	{ buff_y_out_1_ce0 sc_out sc_logic 1 signal 1 } 
	{ buff_y_out_1_q0 sc_in sc_lv 32 signal 1 } 
	{ buff_y_out_2_address0 sc_out sc_lv 4 signal 2 } 
	{ buff_y_out_2_ce0 sc_out sc_logic 1 signal 2 } 
	{ buff_y_out_2_q0 sc_in sc_lv 32 signal 2 } 
	{ buff_y_out_3_address0 sc_out sc_lv 4 signal 3 } 
	{ buff_y_out_3_ce0 sc_out sc_logic 1 signal 3 } 
	{ buff_y_out_3_q0 sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buff_y_out_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff_y_out_2", "role": "q0" }} , 
 	...
 	{ "name": "buff_y_out_3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff_y_out_3", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_32_1_1_U28", "Parent" : "0"},
...
set Spec2ImplPortList { 
	buff_y_out { ap_memory {  { buff_y_out_address0 mem_address 1 4 }  { buff_y_out_ce0 mem_ce 1 1 }  { buff_y_out_q0 in_data 0 32 } } }
	buff_y_out_1 { ap_memory {  { buff_y_out_1_address0 mem_address 1 4 }  { buff_y_out_1_ce0 mem_ce 1 1 }  { buff_y_out_1_q0 in_data 0 32 } } }
	buff_y_out_2 { ap_memory {  { buff_y_out_2_address0 mem_address 1 4 }  { buff_y_out_2_ce0 mem_ce 1 1 }  { buff_y_out_2_q0 in_data 0 32 } } }
	buff_y_out_3 { ap_memory {  { buff_y_out_3_address0 mem_address 1 4 }  { buff_y_out_3_ce0 mem_ce 1 1 }  { buff_y_out_3_q0 in_data 0 32 } } }
