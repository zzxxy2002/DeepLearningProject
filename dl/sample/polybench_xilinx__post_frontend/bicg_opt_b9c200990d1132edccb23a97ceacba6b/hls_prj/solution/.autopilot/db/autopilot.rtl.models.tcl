set SynModuleInfo {
  ...
  {SRCNAME bicg_Pipeline_lp4 MODELNAME bicg_Pipeline_lp4 RTLNAME bicg_bicg_Pipeline_lp4}
  ...
  {SRCNAME bicg MODELNAME bicg RTLNAME bicg IS_TOP 1
    SUBMODULES {
      {MODELNAME bicg_buff_A_RAM_1WNR_AUTO_1R1W RTLNAME bicg_buff_A_RAM_1WNR_AUTO_1R1W BINDTYPE storage TYPE ram_1wnr IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
