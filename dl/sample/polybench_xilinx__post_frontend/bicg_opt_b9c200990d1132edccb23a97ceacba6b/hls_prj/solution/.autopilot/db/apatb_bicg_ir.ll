; ModuleID = '/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/bicg_opt_b9c200990d1132edccb23a97ceacba6b/hls_prj/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_bicg_ir([64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "partition" %A, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %p, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %r, float* noalias nonnull "fpga.decayed.dim.hint"="64" %s_out, float* noalias nonnull "fpga.decayed.dim.hint"="64" %q_out) local_unnamed_addr #1 {
entry:
  ...
  call void @copy_in([64 x [64 x float]]* nonnull %0, [64 x [32 x float]]* %A_copy_0, [64 x [32 x float]]* %A_copy_1, [64 x float]* nonnull %1, [64 x float]* nonnull align 512 %p_copy, [64 x float]* nonnull %2, [64 x float]* nonnull align 512 %r_copy, [64 x float]* nonnull %3, [64 x float]* nonnull align 512 %s_out_copy, [64 x float]* nonnull %4, [64 x float]* nonnull align 512 %q_out_copy)
  ...
  call void @apatb_bicg_hw([64 x [32 x float]]* %A_copy_0, [64 x [32 x float]]* %A_copy_1, [64 x float]* %p_copy, [64 x float]* %r_copy, [64 x float]* %s_out_copy, [64 x float]* %q_out_copy)
  call void @copy_back([64 x [64 x float]]* %0, [64 x [32 x float]]* %A_copy_0, [64 x [32 x float]]* %A_copy_1, [64 x float]* %1, [64 x float]* %p_copy, [64 x float]* %2, [64 x float]* %r_copy, [64 x float]* %3, [64 x float]* %s_out_copy, [64 x float]* %4, [64 x float]* %q_out_copy)
...
declare void @apatb_bicg_hw([64 x [32 x float]]*, [64 x [32 x float]]*, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*)
...
define void @bicg_hw_stub_wrapper([64 x [32 x float]]*, [64 x [32 x float]]*, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*) #7 {
entry:
  %malloccall = tail call i8* @malloc(i64 16384)
  %6 = bitcast i8* %malloccall to [64 x [64 x float]]*
  call void @copy_out([64 x [64 x float]]* %6, [64 x [32 x float]]* %0, [64 x [32 x float]]* %1, [64 x float]* null, [64 x float]* %2, [64 x float]* null, [64 x float]* %3, [64 x float]* null, [64 x float]* %4, [64 x float]* null, [64 x float]* %5)
  %7 = bitcast [64 x [64 x float]]* %6 to [64 x float]*
  %8 = bitcast [64 x float]* %2 to float*
  %9 = bitcast [64 x float]* %3 to float*
  %10 = bitcast [64 x float]* %4 to float*
  %11 = bitcast [64 x float]* %5 to float*
  call void @bicg_hw_stub([64 x float]* %7, float* %8, float* %9, float* %10, float* %11)
  call void @copy_in([64 x [64 x float]]* %6, [64 x [32 x float]]* %0, [64 x [32 x float]]* %1, [64 x float]* null, [64 x float]* %2, [64 x float]* null, [64 x float]* %3, [64 x float]* null, [64 x float]* %4, [64 x float]* null, [64 x float]* %5)
  ret void
}
...
!15 = !DIFile(filename: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/bicg_opt_b9c200990d1132edccb23a97ceacba6b/opt.tcl", directory: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/bicg_opt_b9c200990d1132edccb23a97ceacba6b")
!16 = distinct !DISubprogram(name: "bicg", scope: !17, file: !17, line: 3, type: !18, isLocal: false, isDefinition: true, scopeLine: 4, flags: DIFlagPrototyped, isOptimized: false, unit: !26, variables: !4)
!17 = !DIFile(filename: "src/bicg.c", directory: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/bicg_opt_b9c200990d1132edccb23a97ceacba6b")
!18 = !DISubroutineType(types: !19)
!19 = !{null, !20, !25, !25, !25, !25}
...
!27 = !DIFile(filename: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/bicg_opt_b9c200990d1132edccb23a97ceacba6b/hls_prj/solution/.autopilot/db/bicg.pp.0.c", directory: "/nethome/xxu425/DeepLearningProject/dl/ssam/polybench_xilinx__post_frontend/bicg_opt_b9c200990d1132edccb23a97ceacba6b")
