...
using hls::sim::Byte;
extern "C" void k3mm(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, volatile void *);
...
auto* sE_out = createStream(__xlx_apatb_param_E_out, 4);
  // DUT call
  k3mm(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_D__tmp_vec.data(), __xlx_apatb_param_E_out);
