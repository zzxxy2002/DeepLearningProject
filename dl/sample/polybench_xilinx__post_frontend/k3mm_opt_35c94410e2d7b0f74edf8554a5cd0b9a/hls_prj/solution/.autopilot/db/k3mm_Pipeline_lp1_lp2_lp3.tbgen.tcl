set moduleName k3mm_Pipeline_lp1_lp2_lp3
set isTopModule 0
...
set C_modelName {k3mm_Pipeline_lp1_lp2_lp3}
...
set portList { 
	...
	{ buff_B_address1 sc_out sc_lv 11 signal 2 } 
	...
	{ buff_B_1_address1 sc_out sc_lv 11 signal 3 } 
	{ buff_B_1_ce1 sc_out sc_logic 1 signal 3 } 
	{ buff_B_1_q1 sc_in sc_lv 32 signal 3 } 
	{ tmp1_address0 sc_out sc_lv 12 signal 4 } 
	{ tmp1_ce0 sc_out sc_logic 1 signal 4 } 
	{ tmp1_we0 sc_out sc_logic 1 signal 4 } 
	{ tmp1_d0 sc_out sc_lv 32 signal 4 } 
	{ tmp1_q0 sc_in sc_lv 32 signal 4 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1048583", "Max" : "1048583"}
	, {"Name" : "Interval", "Min" : "1048583", "Max" : "1048583"}
]}
