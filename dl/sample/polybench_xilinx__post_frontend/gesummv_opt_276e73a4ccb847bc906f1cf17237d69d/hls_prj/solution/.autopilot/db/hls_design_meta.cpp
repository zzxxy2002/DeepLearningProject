...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("x_address0", 6, hls_out, 6, "ap_memory", "mem_address", 1),
	Port_Property("x_ce0", 1, hls_out, 6, "ap_memory", "mem_ce", 1),
	Port_Property("x_q0", 32, hls_in, 6, "ap_memory", "in_data", 1),
	Port_Property("y_out_din", 32, hls_out, 7, "ap_fifo", "fifo_data_in", 1),
	Port_Property("y_out_full_n", 1, hls_in, 7, "ap_fifo", "fifo_status", 1),
	Port_Property("y_out_write", 1, hls_out, 7, "ap_fifo", "fifo_port_we", 1),
};
