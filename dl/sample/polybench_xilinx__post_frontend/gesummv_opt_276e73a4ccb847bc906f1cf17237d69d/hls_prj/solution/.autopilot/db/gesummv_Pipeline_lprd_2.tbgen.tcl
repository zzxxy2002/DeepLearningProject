set moduleName gesummv_Pipeline_lprd_2
set isTopModule 0
...
set C_modelName {gesummv_Pipeline_lprd_2}
...
set C_modelArgList {
	...
	{ buff_A float 32 regular {array 2048 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ buff_A_1 float 32 regular {array 2048 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ buff_B float 32 regular {array 2048 { 0 3 } 0 1 }  }
	{ buff_B_1 float 32 regular {array 2048 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ A_0_address0 sc_out sc_lv 11 signal 1 } 
	...
	{ B_0_address0 sc_out sc_lv 11 signal 3 } 
	{ B_0_ce0 sc_out sc_logic 1 signal 3 } 
	{ B_0_q0 sc_in sc_lv 32 signal 3 } 
	{ B_1_address0 sc_out sc_lv 11 signal 4 } 
	{ B_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ B_1_q0 sc_in sc_lv 32 signal 4 } 
	{ buff_A_address0 sc_out sc_lv 11 signal 5 } 
	{ buff_A_ce0 sc_out sc_logic 1 signal 5 } 
	{ buff_A_we0 sc_out sc_logic 1 signal 5 } 
	{ buff_A_d0 sc_out sc_lv 32 signal 5 } 
	{ buff_A_1_address0 sc_out sc_lv 11 signal 6 } 
	{ buff_A_1_ce0 sc_out sc_logic 1 signal 6 } 
	{ buff_A_1_we0 sc_out sc_logic 1 signal 6 } 
	{ buff_A_1_d0 sc_out sc_lv 32 signal 6 } 
	{ buff_B_address0 sc_out sc_lv 11 signal 7 } 
	{ buff_B_ce0 sc_out sc_logic 1 signal 7 } 
	{ buff_B_we0 sc_out sc_logic 1 signal 7 } 
	{ buff_B_d0 sc_out sc_lv 32 signal 7 } 
	{ buff_B_1_address0 sc_out sc_lv 11 signal 8 } 
	{ buff_B_1_ce0 sc_out sc_logic 1 signal 8 } 
	{ buff_B_1_we0 sc_out sc_logic 1 signal 8 } 
	{ buff_B_1_d0 sc_out sc_lv 32 signal 8 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	A_0 { ap_memory {  { A_0_address0 mem_address 1 11 }  { A_0_ce0 mem_ce 1 1 }  { A_0_q0 in_data 0 32 } } }
	A_1 { ap_memory {  { A_1_address0 mem_address 1 11 }  { A_1_ce0 mem_ce 1 1 }  { A_1_q0 in_data 0 32 } } }
	B_0 { ap_memory {  { B_0_address0 mem_address 1 11 }  { B_0_ce0 mem_ce 1 1 }  { B_0_q0 in_data 0 32 } } }
	B_1 { ap_memory {  { B_1_address0 mem_address 1 11 }  { B_1_ce0 mem_ce 1 1 }  { B_1_q0 in_data 0 32 } } }
	buff_A { ap_memory {  { buff_A_address0 mem_address 1 11 }  { buff_A_ce0 mem_ce 1 1 }  { buff_A_we0 mem_we 1 1 }  { buff_A_d0 mem_din 1 32 } } }
	buff_A_1 { ap_memory {  { buff_A_1_address0 mem_address 1 11 }  { buff_A_1_ce0 mem_ce 1 1 }  { buff_A_1_we0 mem_we 1 1 }  { buff_A_1_d0 mem_din 1 32 } } }
	buff_B { ap_memory {  { buff_B_address0 mem_address 1 11 }  { buff_B_ce0 mem_ce 1 1 }  { buff_B_we0 mem_we 1 1 }  { buff_B_d0 mem_din 1 32 } } }
	buff_B_1 { ap_memory {  { buff_B_1_address0 mem_address 1 11 }  { buff_B_1_ce0 mem_ce 1 1 }  { buff_B_1_we0 mem_we 1 1 }  { buff_B_1_d0 mem_din 1 32 } } }
}
