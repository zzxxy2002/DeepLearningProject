...
using hls::sim::Byte;
extern "C" void gesummv(float, float, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, volatile void *);
extern "C" void apatb_gesummv_hw(float __xlx_apatb_param_alpha, float __xlx_apatb_param_beta, volatile void * __xlx_apatb_param_A_0, volatile void * __xlx_apatb_param_A_1, volatile void * __xlx_apatb_param_B_0, volatile void * __xlx_apatb_param_B_1, volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_y_out) {
...
auto* sy_out = createStream(__xlx_apatb_param_y_out, 4);
  // DUT call
  gesummv(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_A_0__tmp_vec.data(), __xlx_A_1__tmp_vec.data(), __xlx_B_0__tmp_vec.data(), __xlx_B_1__tmp_vec.data(), __xlx_x__tmp_vec.data(), __xlx_apatb_param_y_out);
