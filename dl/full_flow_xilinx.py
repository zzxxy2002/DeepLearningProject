...
from hlsfactory.flow_bambu import BambuSynthFlow
...
WORK_DIR_TOP = pathlib.Path("/usr/scratch/hls_tmp")
WORK_DIR = WORK_DIR_TOP / "ssam"
...
VITIS_HLS_PATH = pathlib.Path("/tools/software/xilinx/Vitis_HLS/2023.2")
VIVADO_PATH = pathlib.Path("/tools/software/xilinx/Vivado/2023.2")
...
N_RANDOM_SAMPLES = 1800
RANDOM_SAMPLE_SEED = 85
...
TIMEOUT_HLS_SYNTH = 60.0 * 60 * 8  # 8 minutes
TIMEOUT_HLS_IMPL = 60.0 * 60 * 8  # 30 minutes
